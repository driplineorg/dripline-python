    ...
    void export_message( pybind11::module& mod )
    {
        ...
        ********/
        ...
        message//.def_static("process_envelope", &dripline::message::process_envelope, "From AMQP to message object")
               .def("create_amqp_messages", &dripline::message::create_amqp_messages, "From message object to AMQP")
               .def("encode_message_body", &dripline::message::encode_message_body, "From message object to string")
	       .def("derived_modify_amqp_message", &message_pybind::derived_modify_amqp_message, "derived_modify_amqp_message function")
	    .def("derived_modify_message_param", &message_pybind::derived_modify_message_param, "derived_modify_amqp_message function");
