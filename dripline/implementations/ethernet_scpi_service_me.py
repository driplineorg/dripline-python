...
__all__.append('EthernetSCPIService_me')
class EthernetSCPIService_me(Service):
    '''
    ...
    def __init__(self,
        ...
        if response_terminator[0] is None or response_terminator[0] == ''or len(response_terminator)==0:
    ...
    def _send_commands(self, commands):
        ...
        for command in commands:
            ...
            data = self._listen(blank_command, i)
    ...
    def _listen(self, blank_command=False, terminator=0):
        '''
        ...
        try:
            while True:
                ...
                if data.endswith(self.response_terminator[terminator]):
                    terminator = self.response_terminator[terminator]
                    break
